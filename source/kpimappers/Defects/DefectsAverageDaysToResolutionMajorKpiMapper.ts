...
/**
 * DefectsAverageDaysToResolutionMajor.
 * Average Days To Resolution (DTR) for Major Bugs
 * 
 ...
 */
export class DefectsAverageDaysToResolutionMajorKpiMapper extends KpiMapper
{
    public readonly Title: string = "Average Days to Resolution (Major)";
    
    private _annualTarget: number = kpi.goals.bugs_resolution_time_major.target;
    private _annualStretchGoal: number = kpi.goals.bugs_resolution_time_major.stretch;
