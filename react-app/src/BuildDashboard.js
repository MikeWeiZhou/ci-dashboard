...
class BuildDashboard extends Component {
    state = {
        ...
        routes: [
            ...
            ,"Defects/DefectsAverageDaysToResolutionCritical"
            ,"Defects/DefectsAverageDaysToResolutionMajor"
            ,"Defects/DefectsCreatedResolvedDifference"
            ,"Defects/DefectsTotalBugsCreated"
            ,"Defects/DefectsTotalBugsResolved"
